...
enum opt_code
{
  ...
  OPT_list = 1747,                           /* -list */
  OPT_m128bit_long_double = 1748,            /* -m128bit-long-double */
  OPT_m16 = 1749,                            /* -m16 */
  OPT_m32 = 1750,                            /* -m32 */
  OPT_m3dnow = 1751,                         /* -m3dnow */
  OPT_m3dnowa = 1752,                        /* -m3dnowa */
  OPT_m64 = 1753,                            /* -m64 */
  OPT_m80387 = 1754,                         /* -m80387 */
  OPT_m8bit_idiv = 1755,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1756,             /* -m96bit-long-double */
  OPT_mabi_ = 1757,                          /* -mabi= */
  OPT_mabm = 1758,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1759,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1760,                 /* -maddress-mode= */
  OPT_madx = 1761,                           /* -madx */
  OPT_maes = 1762,                           /* -maes */
  OPT_malign_data_ = 1763,                   /* -malign-data= */
  OPT_malign_double = 1764,                  /* -malign-double */
  OPT_malign_functions_ = 1765,              /* -malign-functions= */
  OPT_malign_jumps_ = 1766,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1767,                  /* -malign-loops= */
  OPT_malign_stringops = 1768,               /* -malign-stringops */
  OPT_mamx_bf16 = 1769,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1770,                      /* -mamx-int8 */
  OPT_mamx_tile = 1771,                      /* -mamx-tile */
  OPT_march_ = 1772,                         /* -march= */
  OPT_masm_ = 1773,                          /* -masm= */
  OPT_mavx = 1774,                           /* -mavx */
  OPT_mavx2 = 1775,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1776,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1777,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1778,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1779,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1780,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1781,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1782,                      /* -mavx512bw */
  OPT_mavx512cd = 1783,                      /* -mavx512cd */
  OPT_mavx512dq = 1784,                      /* -mavx512dq */
  OPT_mavx512er = 1785,                      /* -mavx512er */
  OPT_mavx512f = 1786,                       /* -mavx512f */
  OPT_mavx512fp16 = 1787,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1788,                    /* -mavx512ifma */
  OPT_mavx512pf = 1789,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1790,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1791,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1792,                      /* -mavx512vl */
  OPT_mavx512vnni = 1793,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1794,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1795,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1796,                       /* -mavxvnni */
  OPT_mbmi = 1797,                           /* -mbmi */
  OPT_mbmi2 = 1798,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1799,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1800,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1801,                    /* -mcet-switch */
  OPT_mcld = 1802,                           /* -mcld */
  OPT_mcldemote = 1803,                      /* -mcldemote */
  OPT_mclflushopt = 1804,                    /* -mclflushopt */
  OPT_mclwb = 1805,                          /* -mclwb */
  OPT_mclzero = 1806,                        /* -mclzero */
  OPT_mcmodel_ = 1807,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1808, */                    /* -mcpu= */
  OPT_mcrc32 = 1809,                         /* -mcrc32 */
  OPT_mcx16 = 1810,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1811,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1812,            /* -mdump-tune-features */
  OPT_menqcmd = 1813,                        /* -menqcmd */
  OPT_mf16c = 1814,                          /* -mf16c */
  OPT_mfancy_math_387 = 1815,                /* -mfancy-math-387 */
  OPT_mfentry = 1816,                        /* -mfentry */
  OPT_mfentry_name_ = 1817,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1818,               /* -mfentry-section= */
  OPT_mfma = 1819,                           /* -mfma */
  OPT_mfma4 = 1820,                          /* -mfma4 */
  OPT_mforce_drap = 1821,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1822,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1823,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1824,                       /* -mfpmath= */
  OPT_mfsgsbase = 1825,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1826,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1827, */              /* -mfused-madd */
  OPT_mfxsr = 1828,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1829,             /* -mgeneral-regs-only */
  OPT_mgfni = 1830,                          /* -mgfni */
  OPT_mhard_float = 1831,                    /* -mhard-float */
  OPT_mharden_sls_ = 1832,                   /* -mharden-sls= */
  OPT_mhle = 1833,                           /* -mhle */
  OPT_mhreset = 1834,                        /* -mhreset */
  OPT_miamcu = 1835,                         /* -miamcu */
  OPT_mieee_fp = 1836,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1837,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1838,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1839,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1840,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1841,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1842,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1843,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1844, */            /* -mintel-syntax */
  OPT_mkl = 1845,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1846,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1847,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1848,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1849,                /* -mlong-double-80 */
  OPT_mlwp = 1850,                           /* -mlwp */
  OPT_mlzcnt = 1851,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1852,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1853,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1854,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1855,                  /* -mmitigate-rop */
  OPT_mmmx = 1856,                           /* -mmmx */
  OPT_mmovbe = 1857,                         /* -mmovbe */
  OPT_mmovdir64b = 1858,                     /* -mmovdir64b */
  OPT_mmovdiri = 1859,                       /* -mmovdiri */
  OPT_mmove_max_ = 1860,                     /* -mmove-max= */
  OPT_mmpx = 1861,                           /* -mmpx */
  OPT_mms_bitfields = 1862,                  /* -mms-bitfields */
  OPT_mmwait = 1863,                         /* -mmwait */
  OPT_mmwaitx = 1864,                        /* -mmwaitx */
  OPT_mneeded = 1865,                        /* -mneeded */
  OPT_mno_align_stringops = 1866,            /* -mno-align-stringops */
  OPT_mno_default = 1867,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1868,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1869,                  /* -mno-push-args */
  OPT_mno_red_zone = 1870,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1871,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1872,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1873,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1874,                          /* -mpc32 */
  OPT_mpc64 = 1875,                          /* -mpc64 */
  OPT_mpc80 = 1876,                          /* -mpc80 */
  OPT_mpclmul = 1877,                        /* -mpclmul */
  OPT_mpcommit = 1878,                       /* -mpcommit */
  OPT_mpconfig = 1879,                       /* -mpconfig */
  OPT_mpku = 1880,                           /* -mpku */
  OPT_mpopcnt = 1881,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1882, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1883,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1884,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1885,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1886,                        /* -mprfchw */
  OPT_mptwrite = 1887,                       /* -mptwrite */
  OPT_mpush_args = 1888,                     /* -mpush-args */
  OPT_mrdpid = 1889,                         /* -mrdpid */
  OPT_mrdrnd = 1890,                         /* -mrdrnd */
  OPT_mrdseed = 1891,                        /* -mrdseed */
  OPT_mrecip = 1892,                         /* -mrecip */
  OPT_mrecip_ = 1893,                        /* -mrecip= */
  OPT_mrecord_mcount = 1894,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1895,                 /* -mrecord-return */
  OPT_mred_zone = 1896,                      /* -mred-zone */
  OPT_mregparm_ = 1897,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 1898,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 1899,                           /* -mrtd */
  OPT_mrtm = 1900,                           /* -mrtm */
  OPT_msahf = 1901,                          /* -msahf */
  OPT_mserialize = 1902,                     /* -mserialize */
  OPT_msgx = 1903,                           /* -msgx */
  OPT_msha = 1904,                           /* -msha */
  OPT_mshstk = 1905,                         /* -mshstk */
  OPT_mskip_rax_setup = 1906,                /* -mskip-rax-setup */
  OPT_msoft_float = 1907,                    /* -msoft-float */
  OPT_msse = 1908,                           /* -msse */
  OPT_msse2 = 1909,                          /* -msse2 */
  OPT_msse2avx = 1910,                       /* -msse2avx */
  OPT_msse3 = 1911,                          /* -msse3 */
  OPT_msse4 = 1912,                          /* -msse4 */
  OPT_msse4_1 = 1913,                        /* -msse4.1 */
  OPT_msse4_2 = 1914,                        /* -msse4.2 */
  OPT_msse4a = 1915,                         /* -msse4a */
  /* OPT_msse5 = 1916, */                    /* -msse5 */
  OPT_msseregparm = 1917,                    /* -msseregparm */
  OPT_mssse3 = 1918,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1919,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1920, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1921,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1922, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1923,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1924,                  /* -mstackrealign */
  OPT_mstore_max_ = 1925,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 1926,            /* -mstringop-strategy= */
  OPT_mstv = 1927,                           /* -mstv */
  OPT_mtbm = 1928,                           /* -mtbm */
  OPT_mtls_dialect_ = 1929,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1930,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1931,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1932,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1933,                         /* -mtune= */
  OPT_muintr = 1934,                         /* -muintr */
  OPT_mvaes = 1935,                          /* -mvaes */
  OPT_mveclibabi_ = 1936,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1937,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1938,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1939,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1940,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1941,                      /* -mwbnoinvd */
  OPT_mwidekl = 1942,                        /* -mwidekl */
  OPT_mx32 = 1943,                           /* -mx32 */
  OPT_mxop = 1944,                           /* -mxop */
  OPT_mxsave = 1945,                         /* -mxsave */
  OPT_mxsavec = 1946,                        /* -mxsavec */
  OPT_mxsaveopt = 1947,                      /* -mxsaveopt */
  OPT_mxsaves = 1948,                        /* -mxsaves */
  OPT_n = 1949,                              /* -n */
