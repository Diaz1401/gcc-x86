...
enum opt_code
{
  ...
  OPT_list = 1714,                           /* -list */
  OPT_m128bit_long_double = 1715,            /* -m128bit-long-double */
  OPT_m16 = 1716,                            /* -m16 */
  OPT_m32 = 1717,                            /* -m32 */
  OPT_m3dnow = 1718,                         /* -m3dnow */
  OPT_m3dnowa = 1719,                        /* -m3dnowa */
  OPT_m64 = 1720,                            /* -m64 */
  OPT_m80387 = 1721,                         /* -m80387 */
  OPT_m8bit_idiv = 1722,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1723,             /* -m96bit-long-double */
  OPT_mabi_ = 1724,                          /* -mabi= */
  OPT_mabm = 1725,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1726,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1727,                 /* -maddress-mode= */
  OPT_madx = 1728,                           /* -madx */
  OPT_maes = 1729,                           /* -maes */
  OPT_malign_data_ = 1730,                   /* -malign-data= */
  OPT_malign_double = 1731,                  /* -malign-double */
  OPT_malign_functions_ = 1732,              /* -malign-functions= */
  OPT_malign_jumps_ = 1733,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1734,                  /* -malign-loops= */
  OPT_malign_stringops = 1735,               /* -malign-stringops */
  OPT_mamx_bf16 = 1736,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1737,                      /* -mamx-int8 */
  OPT_mamx_tile = 1738,                      /* -mamx-tile */
  OPT_march_ = 1739,                         /* -march= */
  OPT_masm_ = 1740,                          /* -masm= */
  OPT_mavx = 1741,                           /* -mavx */
  OPT_mavx2 = 1742,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1743,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1744,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1745,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1746,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1747,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1748,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1749,                      /* -mavx512bw */
  OPT_mavx512cd = 1750,                      /* -mavx512cd */
  OPT_mavx512dq = 1751,                      /* -mavx512dq */
  OPT_mavx512er = 1752,                      /* -mavx512er */
  OPT_mavx512f = 1753,                       /* -mavx512f */
  OPT_mavx512fp16 = 1754,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1755,                    /* -mavx512ifma */
  OPT_mavx512pf = 1756,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1757,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1758,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1759,                      /* -mavx512vl */
  OPT_mavx512vnni = 1760,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1761,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1762,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1763,                       /* -mavxvnni */
  OPT_mbmi = 1764,                           /* -mbmi */
  OPT_mbmi2 = 1765,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1766,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1767,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1768,                    /* -mcet-switch */
  OPT_mcld = 1769,                           /* -mcld */
  OPT_mcldemote = 1770,                      /* -mcldemote */
  OPT_mclflushopt = 1771,                    /* -mclflushopt */
  OPT_mclwb = 1772,                          /* -mclwb */
  OPT_mclzero = 1773,                        /* -mclzero */
  OPT_mcmodel_ = 1774,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1775, */                    /* -mcpu= */
  OPT_mcrc32 = 1776,                         /* -mcrc32 */
  OPT_mcx16 = 1777,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1778,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1779,            /* -mdump-tune-features */
  OPT_menqcmd = 1780,                        /* -menqcmd */
  OPT_mf16c = 1781,                          /* -mf16c */
  OPT_mfancy_math_387 = 1782,                /* -mfancy-math-387 */
  OPT_mfentry = 1783,                        /* -mfentry */
  OPT_mfentry_name_ = 1784,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1785,               /* -mfentry-section= */
  OPT_mfma = 1786,                           /* -mfma */
  OPT_mfma4 = 1787,                          /* -mfma4 */
  OPT_mforce_drap = 1788,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1789,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1790,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1791,                       /* -mfpmath= */
  OPT_mfsgsbase = 1792,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1793,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1794, */              /* -mfused-madd */
  OPT_mfxsr = 1795,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1796,             /* -mgeneral-regs-only */
  OPT_mgfni = 1797,                          /* -mgfni */
  OPT_mhard_float = 1798,                    /* -mhard-float */
  OPT_mharden_sls_ = 1799,                   /* -mharden-sls= */
  OPT_mhle = 1800,                           /* -mhle */
  OPT_mhreset = 1801,                        /* -mhreset */
  OPT_miamcu = 1802,                         /* -miamcu */
  OPT_mieee_fp = 1803,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1804,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1805,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1806,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1807,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1808,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1809,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1810,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1811, */            /* -mintel-syntax */
  OPT_mkl = 1812,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1813,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1814,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1815,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1816,                /* -mlong-double-80 */
  OPT_mlwp = 1817,                           /* -mlwp */
  OPT_mlzcnt = 1818,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1819,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1820,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1821,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1822,                  /* -mmitigate-rop */
  OPT_mmmx = 1823,                           /* -mmmx */
  OPT_mmovbe = 1824,                         /* -mmovbe */
  OPT_mmovdir64b = 1825,                     /* -mmovdir64b */
  OPT_mmovdiri = 1826,                       /* -mmovdiri */
  OPT_mmpx = 1827,                           /* -mmpx */
  OPT_mms_bitfields = 1828,                  /* -mms-bitfields */
  OPT_mmwait = 1829,                         /* -mmwait */
  OPT_mmwaitx = 1830,                        /* -mmwaitx */
  OPT_mneeded = 1831,                        /* -mneeded */
  OPT_mno_align_stringops = 1832,            /* -mno-align-stringops */
  OPT_mno_default = 1833,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1834,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1835,                  /* -mno-push-args */
  OPT_mno_red_zone = 1836,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1837,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1838,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1839,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1840,                          /* -mpc32 */
  OPT_mpc64 = 1841,                          /* -mpc64 */
  OPT_mpc80 = 1842,                          /* -mpc80 */
  OPT_mpclmul = 1843,                        /* -mpclmul */
  OPT_mpcommit = 1844,                       /* -mpcommit */
  OPT_mpconfig = 1845,                       /* -mpconfig */
  OPT_mpku = 1846,                           /* -mpku */
  OPT_mpopcnt = 1847,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1848, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1849,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1850,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1851,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1852,                        /* -mprfchw */
  OPT_mptwrite = 1853,                       /* -mptwrite */
  OPT_mpush_args = 1854,                     /* -mpush-args */
  OPT_mrdpid = 1855,                         /* -mrdpid */
  OPT_mrdrnd = 1856,                         /* -mrdrnd */
  OPT_mrdseed = 1857,                        /* -mrdseed */
  OPT_mrecip = 1858,                         /* -mrecip */
  OPT_mrecip_ = 1859,                        /* -mrecip= */
  OPT_mrecord_mcount = 1860,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1861,                 /* -mrecord-return */
  OPT_mred_zone = 1862,                      /* -mred-zone */
  OPT_mregparm_ = 1863,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 1864,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 1865,                           /* -mrtd */
  OPT_mrtm = 1866,                           /* -mrtm */
  OPT_msahf = 1867,                          /* -msahf */
  OPT_mserialize = 1868,                     /* -mserialize */
  OPT_msgx = 1869,                           /* -msgx */
  OPT_msha = 1870,                           /* -msha */
  OPT_mshstk = 1871,                         /* -mshstk */
  OPT_mskip_rax_setup = 1872,                /* -mskip-rax-setup */
  OPT_msoft_float = 1873,                    /* -msoft-float */
  OPT_msse = 1874,                           /* -msse */
  OPT_msse2 = 1875,                          /* -msse2 */
  OPT_msse2avx = 1876,                       /* -msse2avx */
  OPT_msse3 = 1877,                          /* -msse3 */
  OPT_msse4 = 1878,                          /* -msse4 */
  OPT_msse4_1 = 1879,                        /* -msse4.1 */
  OPT_msse4_2 = 1880,                        /* -msse4.2 */
  OPT_msse4a = 1881,                         /* -msse4a */
  /* OPT_msse5 = 1882, */                    /* -msse5 */
  OPT_msseregparm = 1883,                    /* -msseregparm */
  OPT_mssse3 = 1884,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1885,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1886, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1887,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1888, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1889,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1890,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1891,            /* -mstringop-strategy= */
  OPT_mstv = 1892,                           /* -mstv */
  OPT_mtbm = 1893,                           /* -mtbm */
  OPT_mtls_dialect_ = 1894,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1895,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1896,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1897,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1898,                         /* -mtune= */
  OPT_muintr = 1899,                         /* -muintr */
  OPT_mvaes = 1900,                          /* -mvaes */
  OPT_mveclibabi_ = 1901,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1902,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1903,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1904,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1905,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1906,                      /* -mwbnoinvd */
  OPT_mwidekl = 1907,                        /* -mwidekl */
  OPT_mx32 = 1908,                           /* -mx32 */
  OPT_mxop = 1909,                           /* -mxop */
  OPT_mxsave = 1910,                         /* -mxsave */
  OPT_mxsavec = 1911,                        /* -mxsavec */
  OPT_mxsaveopt = 1912,                      /* -mxsaveopt */
  OPT_mxsaves = 1913,                        /* -mxsaves */
  OPT_n = 1914,                              /* -n */
