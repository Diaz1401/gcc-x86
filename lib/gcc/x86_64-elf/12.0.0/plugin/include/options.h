...
enum opt_code
{
  ...
  OPT_list = 1744,                           /* -list */
  OPT_m128bit_long_double = 1745,            /* -m128bit-long-double */
  OPT_m16 = 1746,                            /* -m16 */
  OPT_m32 = 1747,                            /* -m32 */
  OPT_m3dnow = 1748,                         /* -m3dnow */
  OPT_m3dnowa = 1749,                        /* -m3dnowa */
  OPT_m64 = 1750,                            /* -m64 */
  OPT_m80387 = 1751,                         /* -m80387 */
  OPT_m8bit_idiv = 1752,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1753,             /* -m96bit-long-double */
  OPT_mabi_ = 1754,                          /* -mabi= */
  OPT_mabm = 1755,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1756,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1757,                 /* -maddress-mode= */
  OPT_madx = 1758,                           /* -madx */
  OPT_maes = 1759,                           /* -maes */
  OPT_malign_data_ = 1760,                   /* -malign-data= */
  OPT_malign_double = 1761,                  /* -malign-double */
  OPT_malign_functions_ = 1762,              /* -malign-functions= */
  OPT_malign_jumps_ = 1763,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1764,                  /* -malign-loops= */
  OPT_malign_stringops = 1765,               /* -malign-stringops */
  OPT_mamx_bf16 = 1766,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1767,                      /* -mamx-int8 */
  OPT_mamx_tile = 1768,                      /* -mamx-tile */
  OPT_march_ = 1769,                         /* -march= */
  OPT_masm_ = 1770,                          /* -masm= */
  OPT_mavx = 1771,                           /* -mavx */
  OPT_mavx2 = 1772,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1773,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1774,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1775,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1776,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1777,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1778,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1779,                      /* -mavx512bw */
  OPT_mavx512cd = 1780,                      /* -mavx512cd */
  OPT_mavx512dq = 1781,                      /* -mavx512dq */
  OPT_mavx512er = 1782,                      /* -mavx512er */
  OPT_mavx512f = 1783,                       /* -mavx512f */
  OPT_mavx512fp16 = 1784,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1785,                    /* -mavx512ifma */
  OPT_mavx512pf = 1786,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1787,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1788,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1789,                      /* -mavx512vl */
  OPT_mavx512vnni = 1790,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1791,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1792,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1793,                       /* -mavxvnni */
  OPT_mbmi = 1794,                           /* -mbmi */
  OPT_mbmi2 = 1795,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1796,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1797,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1798,                    /* -mcet-switch */
  OPT_mcld = 1799,                           /* -mcld */
  OPT_mcldemote = 1800,                      /* -mcldemote */
  OPT_mclflushopt = 1801,                    /* -mclflushopt */
  OPT_mclwb = 1802,                          /* -mclwb */
  OPT_mclzero = 1803,                        /* -mclzero */
  OPT_mcmodel_ = 1804,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1805, */                    /* -mcpu= */
  OPT_mcrc32 = 1806,                         /* -mcrc32 */
  OPT_mcx16 = 1807,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1808,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1809,            /* -mdump-tune-features */
  OPT_menqcmd = 1810,                        /* -menqcmd */
  OPT_mf16c = 1811,                          /* -mf16c */
  OPT_mfancy_math_387 = 1812,                /* -mfancy-math-387 */
  OPT_mfentry = 1813,                        /* -mfentry */
  OPT_mfentry_name_ = 1814,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1815,               /* -mfentry-section= */
  OPT_mfma = 1816,                           /* -mfma */
  OPT_mfma4 = 1817,                          /* -mfma4 */
  OPT_mforce_drap = 1818,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1819,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1820,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1821,                       /* -mfpmath= */
  OPT_mfsgsbase = 1822,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1823,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1824, */              /* -mfused-madd */
  OPT_mfxsr = 1825,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1826,             /* -mgeneral-regs-only */
  OPT_mgfni = 1827,                          /* -mgfni */
  OPT_mhard_float = 1828,                    /* -mhard-float */
  OPT_mharden_sls_ = 1829,                   /* -mharden-sls= */
  OPT_mhle = 1830,                           /* -mhle */
  OPT_mhreset = 1831,                        /* -mhreset */
  OPT_miamcu = 1832,                         /* -miamcu */
  OPT_mieee_fp = 1833,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1834,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1835,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1836,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1837,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1838,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1839,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1840,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1841, */            /* -mintel-syntax */
  OPT_mkl = 1842,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1843,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1844,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1845,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1846,                /* -mlong-double-80 */
  OPT_mlwp = 1847,                           /* -mlwp */
  OPT_mlzcnt = 1848,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1849,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1850,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1851,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1852,                  /* -mmitigate-rop */
  OPT_mmmx = 1853,                           /* -mmmx */
  OPT_mmovbe = 1854,                         /* -mmovbe */
  OPT_mmovdir64b = 1855,                     /* -mmovdir64b */
  OPT_mmovdiri = 1856,                       /* -mmovdiri */
  OPT_mmove_max_ = 1857,                     /* -mmove-max= */
  OPT_mmpx = 1858,                           /* -mmpx */
  OPT_mms_bitfields = 1859,                  /* -mms-bitfields */
  OPT_mmwait = 1860,                         /* -mmwait */
  OPT_mmwaitx = 1861,                        /* -mmwaitx */
  OPT_mneeded = 1862,                        /* -mneeded */
  OPT_mno_align_stringops = 1863,            /* -mno-align-stringops */
  OPT_mno_default = 1864,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1865,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1866,                  /* -mno-push-args */
  OPT_mno_red_zone = 1867,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1868,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1869,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1870,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1871,                          /* -mpc32 */
  OPT_mpc64 = 1872,                          /* -mpc64 */
  OPT_mpc80 = 1873,                          /* -mpc80 */
  OPT_mpclmul = 1874,                        /* -mpclmul */
  OPT_mpcommit = 1875,                       /* -mpcommit */
  OPT_mpconfig = 1876,                       /* -mpconfig */
  OPT_mpku = 1877,                           /* -mpku */
  OPT_mpopcnt = 1878,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1879, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1880,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1881,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1882,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1883,                        /* -mprfchw */
  OPT_mptwrite = 1884,                       /* -mptwrite */
  OPT_mpush_args = 1885,                     /* -mpush-args */
  OPT_mrdpid = 1886,                         /* -mrdpid */
  OPT_mrdrnd = 1887,                         /* -mrdrnd */
  OPT_mrdseed = 1888,                        /* -mrdseed */
  OPT_mrecip = 1889,                         /* -mrecip */
  OPT_mrecip_ = 1890,                        /* -mrecip= */
  OPT_mrecord_mcount = 1891,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1892,                 /* -mrecord-return */
  OPT_mred_zone = 1893,                      /* -mred-zone */
  OPT_mregparm_ = 1894,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 1895,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 1896,                           /* -mrtd */
  OPT_mrtm = 1897,                           /* -mrtm */
  OPT_msahf = 1898,                          /* -msahf */
  OPT_mserialize = 1899,                     /* -mserialize */
  OPT_msgx = 1900,                           /* -msgx */
  OPT_msha = 1901,                           /* -msha */
  OPT_mshstk = 1902,                         /* -mshstk */
  OPT_mskip_rax_setup = 1903,                /* -mskip-rax-setup */
  OPT_msoft_float = 1904,                    /* -msoft-float */
  OPT_msse = 1905,                           /* -msse */
  OPT_msse2 = 1906,                          /* -msse2 */
  OPT_msse2avx = 1907,                       /* -msse2avx */
  OPT_msse3 = 1908,                          /* -msse3 */
  OPT_msse4 = 1909,                          /* -msse4 */
  OPT_msse4_1 = 1910,                        /* -msse4.1 */
  OPT_msse4_2 = 1911,                        /* -msse4.2 */
  OPT_msse4a = 1912,                         /* -msse4a */
  /* OPT_msse5 = 1913, */                    /* -msse5 */
  OPT_msseregparm = 1914,                    /* -msseregparm */
  OPT_mssse3 = 1915,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1916,               /* -mstack-arg-probe */
  ...
  OPT_mstack_protector_guard_symbol_ = 1919, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1920,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1921,                  /* -mstackrealign */
  OPT_mstore_max_ = 1922,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 1923,            /* -mstringop-strategy= */
  OPT_mstv = 1924,                           /* -mstv */
  OPT_mtbm = 1925,                           /* -mtbm */
  OPT_mtls_dialect_ = 1926,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1927,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1928,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1929,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1930,                         /* -mtune= */
  OPT_muintr = 1931,                         /* -muintr */
  OPT_mvaes = 1932,                          /* -mvaes */
  OPT_mveclibabi_ = 1933,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1934,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1935,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1936,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1937,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1938,                      /* -mwbnoinvd */
  OPT_mwidekl = 1939,                        /* -mwidekl */
  OPT_mx32 = 1940,                           /* -mx32 */
  OPT_mxop = 1941,                           /* -mxop */
  OPT_mxsave = 1942,                         /* -mxsave */
  OPT_mxsavec = 1943,                        /* -mxsavec */
  OPT_mxsaveopt = 1944,                      /* -mxsaveopt */
  OPT_mxsaves = 1945,                        /* -mxsaves */
  OPT_n = 1946,                              /* -n */
