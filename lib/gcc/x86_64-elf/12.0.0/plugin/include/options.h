...
enum opt_code
{
  ...
  OPT_list = 1748,                           /* -list */
  OPT_m128bit_long_double = 1749,            /* -m128bit-long-double */
  OPT_m16 = 1750,                            /* -m16 */
  OPT_m32 = 1751,                            /* -m32 */
  OPT_m3dnow = 1752,                         /* -m3dnow */
  OPT_m3dnowa = 1753,                        /* -m3dnowa */
  OPT_m64 = 1754,                            /* -m64 */
  OPT_m80387 = 1755,                         /* -m80387 */
  OPT_m8bit_idiv = 1756,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1757,             /* -m96bit-long-double */
  OPT_mabi_ = 1758,                          /* -mabi= */
  OPT_mabm = 1759,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1760,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1761,                 /* -maddress-mode= */
  OPT_madx = 1762,                           /* -madx */
  OPT_maes = 1763,                           /* -maes */
  OPT_malign_data_ = 1764,                   /* -malign-data= */
  OPT_malign_double = 1765,                  /* -malign-double */
  OPT_malign_functions_ = 1766,              /* -malign-functions= */
  OPT_malign_jumps_ = 1767,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1768,                  /* -malign-loops= */
  OPT_malign_stringops = 1769,               /* -malign-stringops */
  OPT_mamx_bf16 = 1770,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1771,                      /* -mamx-int8 */
  OPT_mamx_tile = 1772,                      /* -mamx-tile */
  OPT_march_ = 1773,                         /* -march= */
  OPT_masm_ = 1774,                          /* -masm= */
  OPT_mavx = 1775,                           /* -mavx */
  OPT_mavx2 = 1776,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1777,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1778,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1779,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1780,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1781,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1782,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1783,                      /* -mavx512bw */
  OPT_mavx512cd = 1784,                      /* -mavx512cd */
  OPT_mavx512dq = 1785,                      /* -mavx512dq */
  OPT_mavx512er = 1786,                      /* -mavx512er */
  OPT_mavx512f = 1787,                       /* -mavx512f */
  OPT_mavx512fp16 = 1788,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1789,                    /* -mavx512ifma */
  OPT_mavx512pf = 1790,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1791,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1792,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1793,                      /* -mavx512vl */
  OPT_mavx512vnni = 1794,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1795,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1796,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1797,                       /* -mavxvnni */
  OPT_mbmi = 1798,                           /* -mbmi */
  OPT_mbmi2 = 1799,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1800,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1801,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1802,                    /* -mcet-switch */
  OPT_mcld = 1803,                           /* -mcld */
  OPT_mcldemote = 1804,                      /* -mcldemote */
  OPT_mclflushopt = 1805,                    /* -mclflushopt */
  OPT_mclwb = 1806,                          /* -mclwb */
  OPT_mclzero = 1807,                        /* -mclzero */
  OPT_mcmodel_ = 1808,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1809, */                    /* -mcpu= */
  OPT_mcrc32 = 1810,                         /* -mcrc32 */
  OPT_mcx16 = 1811,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1812,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1813,            /* -mdump-tune-features */
  OPT_menqcmd = 1814,                        /* -menqcmd */
  OPT_mf16c = 1815,                          /* -mf16c */
  OPT_mfancy_math_387 = 1816,                /* -mfancy-math-387 */
  OPT_mfentry = 1817,                        /* -mfentry */
  OPT_mfentry_name_ = 1818,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1819,               /* -mfentry-section= */
  OPT_mfma = 1820,                           /* -mfma */
  OPT_mfma4 = 1821,                          /* -mfma4 */
  OPT_mforce_drap = 1822,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1823,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1824,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1825,                       /* -mfpmath= */
  OPT_mfsgsbase = 1826,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1827,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1828, */              /* -mfused-madd */
  OPT_mfxsr = 1829,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1830,             /* -mgeneral-regs-only */
  OPT_mgfni = 1831,                          /* -mgfni */
  OPT_mhard_float = 1832,                    /* -mhard-float */
  OPT_mharden_sls_ = 1833,                   /* -mharden-sls= */
  OPT_mhle = 1834,                           /* -mhle */
  OPT_mhreset = 1835,                        /* -mhreset */
  OPT_miamcu = 1836,                         /* -miamcu */
  OPT_mieee_fp = 1837,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1838,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1839,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1840,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1841,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1842,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1843,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1844,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1845, */            /* -mintel-syntax */
  OPT_mkl = 1846,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1847,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1848,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1849,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1850,                /* -mlong-double-80 */
  OPT_mlwp = 1851,                           /* -mlwp */
  OPT_mlzcnt = 1852,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1853,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1854,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1855,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1856,                  /* -mmitigate-rop */
  OPT_mmmx = 1857,                           /* -mmmx */
  OPT_mmovbe = 1858,                         /* -mmovbe */
  OPT_mmovdir64b = 1859,                     /* -mmovdir64b */
  OPT_mmovdiri = 1860,                       /* -mmovdiri */
  OPT_mmove_max_ = 1861,                     /* -mmove-max= */
  OPT_mmpx = 1862,                           /* -mmpx */
  OPT_mms_bitfields = 1863,                  /* -mms-bitfields */
  OPT_mmwait = 1864,                         /* -mmwait */
  OPT_mmwaitx = 1865,                        /* -mmwaitx */
  OPT_mneeded = 1866,                        /* -mneeded */
  OPT_mno_align_stringops = 1867,            /* -mno-align-stringops */
  OPT_mno_default = 1868,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1869,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1870,                  /* -mno-push-args */
  OPT_mno_red_zone = 1871,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1872,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1873,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1874,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1875,                          /* -mpc32 */
  OPT_mpc64 = 1876,                          /* -mpc64 */
  OPT_mpc80 = 1877,                          /* -mpc80 */
  OPT_mpclmul = 1878,                        /* -mpclmul */
  OPT_mpcommit = 1879,                       /* -mpcommit */
  OPT_mpconfig = 1880,                       /* -mpconfig */
  OPT_mpku = 1881,                           /* -mpku */
  OPT_mpopcnt = 1882,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1883, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1884,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1885,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1886,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1887,                        /* -mprfchw */
  OPT_mptwrite = 1888,                       /* -mptwrite */
  OPT_mpush_args = 1889,                     /* -mpush-args */
  OPT_mrdpid = 1890,                         /* -mrdpid */
  OPT_mrdrnd = 1891,                         /* -mrdrnd */
  OPT_mrdseed = 1892,                        /* -mrdseed */
  OPT_mrecip = 1893,                         /* -mrecip */
  OPT_mrecip_ = 1894,                        /* -mrecip= */
  OPT_mrecord_mcount = 1895,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1896,                 /* -mrecord-return */
  OPT_mred_zone = 1897,                      /* -mred-zone */
  OPT_mregparm_ = 1898,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 1899,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 1900,                           /* -mrtd */
  OPT_mrtm = 1901,                           /* -mrtm */
  OPT_msahf = 1902,                          /* -msahf */
  OPT_mserialize = 1903,                     /* -mserialize */
  OPT_msgx = 1904,                           /* -msgx */
  OPT_msha = 1905,                           /* -msha */
  OPT_mshstk = 1906,                         /* -mshstk */
  OPT_mskip_rax_setup = 1907,                /* -mskip-rax-setup */
  OPT_msoft_float = 1908,                    /* -msoft-float */
  OPT_msse = 1909,                           /* -msse */
  OPT_msse2 = 1910,                          /* -msse2 */
  OPT_msse2avx = 1911,                       /* -msse2avx */
  OPT_msse3 = 1912,                          /* -msse3 */
  OPT_msse4 = 1913,                          /* -msse4 */
  OPT_msse4_1 = 1914,                        /* -msse4.1 */
  OPT_msse4_2 = 1915,                        /* -msse4.2 */
  OPT_msse4a = 1916,                         /* -msse4a */
  /* OPT_msse5 = 1917, */                    /* -msse5 */
  OPT_msseregparm = 1918,                    /* -msseregparm */
  OPT_mssse3 = 1919,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1920,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1921, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1922,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1923, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1924,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1925,                  /* -mstackrealign */
  OPT_mstore_max_ = 1926,                    /* -mstore-max= */
  OPT_mstringop_strategy_ = 1927,            /* -mstringop-strategy= */
  OPT_mstv = 1928,                           /* -mstv */
  OPT_mtbm = 1929,                           /* -mtbm */
  OPT_mtls_dialect_ = 1930,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1931,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1932,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1933,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1934,                         /* -mtune= */
  OPT_muintr = 1935,                         /* -muintr */
  OPT_mvaes = 1936,                          /* -mvaes */
  OPT_mveclibabi_ = 1937,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1938,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1939,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1940,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1941,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1942,                      /* -mwbnoinvd */
  OPT_mwidekl = 1943,                        /* -mwidekl */
  OPT_mx32 = 1944,                           /* -mx32 */
  OPT_mxop = 1945,                           /* -mxop */
  OPT_mxsave = 1946,                         /* -mxsave */
  OPT_mxsavec = 1947,                        /* -mxsavec */
  OPT_mxsaveopt = 1948,                      /* -mxsaveopt */
  OPT_mxsaves = 1949,                        /* -mxsaves */
  OPT_n = 1950,                              /* -n */
