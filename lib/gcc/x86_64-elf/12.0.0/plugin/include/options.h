...
enum opt_code
{
  ...
  OPT_list = 1713,                           /* -list */
  OPT_m128bit_long_double = 1714,            /* -m128bit-long-double */
  OPT_m16 = 1715,                            /* -m16 */
  OPT_m32 = 1716,                            /* -m32 */
  OPT_m3dnow = 1717,                         /* -m3dnow */
  OPT_m3dnowa = 1718,                        /* -m3dnowa */
  OPT_m64 = 1719,                            /* -m64 */
  OPT_m80387 = 1720,                         /* -m80387 */
  OPT_m8bit_idiv = 1721,                     /* -m8bit-idiv */
  OPT_m96bit_long_double = 1722,             /* -m96bit-long-double */
  OPT_mabi_ = 1723,                          /* -mabi= */
  OPT_mabm = 1724,                           /* -mabm */
  OPT_maccumulate_outgoing_args = 1725,      /* -maccumulate-outgoing-args */
  OPT_maddress_mode_ = 1726,                 /* -maddress-mode= */
  OPT_madx = 1727,                           /* -madx */
  OPT_maes = 1728,                           /* -maes */
  OPT_malign_data_ = 1729,                   /* -malign-data= */
  OPT_malign_double = 1730,                  /* -malign-double */
  OPT_malign_functions_ = 1731,              /* -malign-functions= */
  OPT_malign_jumps_ = 1732,                  /* -malign-jumps= */
  OPT_malign_loops_ = 1733,                  /* -malign-loops= */
  OPT_malign_stringops = 1734,               /* -malign-stringops */
  OPT_mamx_bf16 = 1735,                      /* -mamx-bf16 */
  OPT_mamx_int8 = 1736,                      /* -mamx-int8 */
  OPT_mamx_tile = 1737,                      /* -mamx-tile */
  OPT_march_ = 1738,                         /* -march= */
  OPT_masm_ = 1739,                          /* -masm= */
  OPT_mavx = 1740,                           /* -mavx */
  OPT_mavx2 = 1741,                          /* -mavx2 */
  OPT_mavx256_split_unaligned_load = 1742,   /* -mavx256-split-unaligned-load */
  OPT_mavx256_split_unaligned_store = 1743,  /* -mavx256-split-unaligned-store */
  OPT_mavx5124fmaps = 1744,                  /* -mavx5124fmaps */
  OPT_mavx5124vnniw = 1745,                  /* -mavx5124vnniw */
  OPT_mavx512bf16 = 1746,                    /* -mavx512bf16 */
  OPT_mavx512bitalg = 1747,                  /* -mavx512bitalg */
  OPT_mavx512bw = 1748,                      /* -mavx512bw */
  OPT_mavx512cd = 1749,                      /* -mavx512cd */
  OPT_mavx512dq = 1750,                      /* -mavx512dq */
  OPT_mavx512er = 1751,                      /* -mavx512er */
  OPT_mavx512f = 1752,                       /* -mavx512f */
  OPT_mavx512fp16 = 1753,                    /* -mavx512fp16 */
  OPT_mavx512ifma = 1754,                    /* -mavx512ifma */
  OPT_mavx512pf = 1755,                      /* -mavx512pf */
  OPT_mavx512vbmi = 1756,                    /* -mavx512vbmi */
  OPT_mavx512vbmi2 = 1757,                   /* -mavx512vbmi2 */
  OPT_mavx512vl = 1758,                      /* -mavx512vl */
  OPT_mavx512vnni = 1759,                    /* -mavx512vnni */
  OPT_mavx512vp2intersect = 1760,            /* -mavx512vp2intersect */
  OPT_mavx512vpopcntdq = 1761,               /* -mavx512vpopcntdq */
  OPT_mavxvnni = 1762,                       /* -mavxvnni */
  OPT_mbmi = 1763,                           /* -mbmi */
  OPT_mbmi2 = 1764,                          /* -mbmi2 */
  OPT_mbranch_cost_ = 1765,                  /* -mbranch-cost= */
  OPT_mcall_ms2sysv_xlogues = 1766,          /* -mcall-ms2sysv-xlogues */
  OPT_mcet_switch = 1767,                    /* -mcet-switch */
  OPT_mcld = 1768,                           /* -mcld */
  OPT_mcldemote = 1769,                      /* -mcldemote */
  OPT_mclflushopt = 1770,                    /* -mclflushopt */
  OPT_mclwb = 1771,                          /* -mclwb */
  OPT_mclzero = 1772,                        /* -mclzero */
  OPT_mcmodel_ = 1773,                       /* -mcmodel= */
  /* OPT_mcpu_ = 1774, */                    /* -mcpu= */
  OPT_mcrc32 = 1775,                         /* -mcrc32 */
  OPT_mcx16 = 1776,                          /* -mcx16 */
  OPT_mdispatch_scheduler = 1777,            /* -mdispatch-scheduler */
  OPT_mdump_tune_features = 1778,            /* -mdump-tune-features */
  OPT_menqcmd = 1779,                        /* -menqcmd */
  OPT_mf16c = 1780,                          /* -mf16c */
  OPT_mfancy_math_387 = 1781,                /* -mfancy-math-387 */
  OPT_mfentry = 1782,                        /* -mfentry */
  OPT_mfentry_name_ = 1783,                  /* -mfentry-name= */
  OPT_mfentry_section_ = 1784,               /* -mfentry-section= */
  OPT_mfma = 1785,                           /* -mfma */
  OPT_mfma4 = 1786,                          /* -mfma4 */
  OPT_mforce_drap = 1787,                    /* -mforce-drap */
  OPT_mforce_indirect_call = 1788,           /* -mforce-indirect-call */
  OPT_mfp_ret_in_387 = 1789,                 /* -mfp-ret-in-387 */
  OPT_mfpmath_ = 1790,                       /* -mfpmath= */
  OPT_mfsgsbase = 1791,                      /* -mfsgsbase */
  OPT_mfunction_return_ = 1792,              /* -mfunction-return= */
  /* OPT_mfused_madd = 1793, */              /* -mfused-madd */
  OPT_mfxsr = 1794,                          /* -mfxsr */
  OPT_mgeneral_regs_only = 1795,             /* -mgeneral-regs-only */
  OPT_mgfni = 1796,                          /* -mgfni */
  OPT_mhard_float = 1797,                    /* -mhard-float */
  OPT_mharden_sls_ = 1798,                   /* -mharden-sls= */
  OPT_mhle = 1799,                           /* -mhle */
  OPT_mhreset = 1800,                        /* -mhreset */
  OPT_miamcu = 1801,                         /* -miamcu */
  OPT_mieee_fp = 1802,                       /* -mieee-fp */
  OPT_mincoming_stack_boundary_ = 1803,      /* -mincoming-stack-boundary= */
  OPT_mindirect_branch_cs_prefix = 1804,     /* -mindirect-branch-cs-prefix */
  OPT_mindirect_branch_register = 1805,      /* -mindirect-branch-register */
  OPT_mindirect_branch_ = 1806,              /* -mindirect-branch= */
  OPT_minline_all_stringops = 1807,          /* -minline-all-stringops */
  OPT_minline_stringops_dynamically = 1808,  /* -minline-stringops-dynamically */
  OPT_minstrument_return_ = 1809,            /* -minstrument-return= */
  /* OPT_mintel_syntax = 1810, */            /* -mintel-syntax */
  OPT_mkl = 1811,                            /* -mkl */
  OPT_mlarge_data_threshold_ = 1812,         /* -mlarge-data-threshold= */
  OPT_mlong_double_128 = 1813,               /* -mlong-double-128 */
  OPT_mlong_double_64 = 1814,                /* -mlong-double-64 */
  OPT_mlong_double_80 = 1815,                /* -mlong-double-80 */
  OPT_mlwp = 1816,                           /* -mlwp */
  OPT_mlzcnt = 1817,                         /* -mlzcnt */
  OPT_mmanual_endbr = 1818,                  /* -mmanual-endbr */
  OPT_mmemcpy_strategy_ = 1819,              /* -mmemcpy-strategy= */
  OPT_mmemset_strategy_ = 1820,              /* -mmemset-strategy= */
  OPT_mmitigate_rop = 1821,                  /* -mmitigate-rop */
  OPT_mmmx = 1822,                           /* -mmmx */
  OPT_mmovbe = 1823,                         /* -mmovbe */
  OPT_mmovdir64b = 1824,                     /* -mmovdir64b */
  OPT_mmovdiri = 1825,                       /* -mmovdiri */
  OPT_mmpx = 1826,                           /* -mmpx */
  OPT_mms_bitfields = 1827,                  /* -mms-bitfields */
  OPT_mmwait = 1828,                         /* -mmwait */
  OPT_mmwaitx = 1829,                        /* -mmwaitx */
  OPT_mneeded = 1830,                        /* -mneeded */
  OPT_mno_align_stringops = 1831,            /* -mno-align-stringops */
  OPT_mno_default = 1832,                    /* -mno-default */
  OPT_mno_fancy_math_387 = 1833,             /* -mno-fancy-math-387 */
  OPT_mno_push_args = 1834,                  /* -mno-push-args */
  OPT_mno_red_zone = 1835,                   /* -mno-red-zone */
  OPT_mno_sse4 = 1836,                       /* -mno-sse4 */
  OPT_mnop_mcount = 1837,                    /* -mnop-mcount */
  OPT_momit_leaf_frame_pointer = 1838,       /* -momit-leaf-frame-pointer */
  OPT_mpc32 = 1839,                          /* -mpc32 */
  OPT_mpc64 = 1840,                          /* -mpc64 */
  OPT_mpc80 = 1841,                          /* -mpc80 */
  OPT_mpclmul = 1842,                        /* -mpclmul */
  OPT_mpcommit = 1843,                       /* -mpcommit */
  OPT_mpconfig = 1844,                       /* -mpconfig */
  OPT_mpku = 1845,                           /* -mpku */
  OPT_mpopcnt = 1846,                        /* -mpopcnt */
  /* OPT_mprefer_avx128 = 1847, */           /* -mprefer-avx128 */
  OPT_mprefer_vector_width_ = 1848,          /* -mprefer-vector-width= */
  OPT_mpreferred_stack_boundary_ = 1849,     /* -mpreferred-stack-boundary= */
  OPT_mprefetchwt1 = 1850,                   /* -mprefetchwt1 */
  OPT_mprfchw = 1851,                        /* -mprfchw */
  OPT_mptwrite = 1852,                       /* -mptwrite */
  OPT_mpush_args = 1853,                     /* -mpush-args */
  OPT_mrdpid = 1854,                         /* -mrdpid */
  OPT_mrdrnd = 1855,                         /* -mrdrnd */
  OPT_mrdseed = 1856,                        /* -mrdseed */
  OPT_mrecip = 1857,                         /* -mrecip */
  OPT_mrecip_ = 1858,                        /* -mrecip= */
  OPT_mrecord_mcount = 1859,                 /* -mrecord-mcount */
  OPT_mrecord_return = 1860,                 /* -mrecord-return */
  OPT_mred_zone = 1861,                      /* -mred-zone */
  OPT_mregparm_ = 1862,                      /* -mregparm= */
  OPT_mrelax_cmpxchg_loop = 1863,            /* -mrelax-cmpxchg-loop */
  OPT_mrtd = 1864,                           /* -mrtd */
  OPT_mrtm = 1865,                           /* -mrtm */
  OPT_msahf = 1866,                          /* -msahf */
  OPT_mserialize = 1867,                     /* -mserialize */
  OPT_msgx = 1868,                           /* -msgx */
  OPT_msha = 1869,                           /* -msha */
  OPT_mshstk = 1870,                         /* -mshstk */
  OPT_mskip_rax_setup = 1871,                /* -mskip-rax-setup */
  OPT_msoft_float = 1872,                    /* -msoft-float */
  OPT_msse = 1873,                           /* -msse */
  OPT_msse2 = 1874,                          /* -msse2 */
  OPT_msse2avx = 1875,                       /* -msse2avx */
  OPT_msse3 = 1876,                          /* -msse3 */
  OPT_msse4 = 1877,                          /* -msse4 */
  OPT_msse4_1 = 1878,                        /* -msse4.1 */
  OPT_msse4_2 = 1879,                        /* -msse4.2 */
  OPT_msse4a = 1880,                         /* -msse4a */
  /* OPT_msse5 = 1881, */                    /* -msse5 */
  OPT_msseregparm = 1882,                    /* -msseregparm */
  OPT_mssse3 = 1883,                         /* -mssse3 */
  OPT_mstack_arg_probe = 1884,               /* -mstack-arg-probe */
  OPT_mstack_protector_guard_offset_ = 1885, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 1886,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_symbol_ = 1887, /* -mstack-protector-guard-symbol= */
  OPT_mstack_protector_guard_ = 1888,        /* -mstack-protector-guard= */
  OPT_mstackrealign = 1889,                  /* -mstackrealign */
  OPT_mstringop_strategy_ = 1890,            /* -mstringop-strategy= */
  OPT_mstv = 1891,                           /* -mstv */
  OPT_mtbm = 1892,                           /* -mtbm */
  OPT_mtls_dialect_ = 1893,                  /* -mtls-dialect= */
  OPT_mtls_direct_seg_refs = 1894,           /* -mtls-direct-seg-refs */
  OPT_mtsxldtrk = 1895,                      /* -mtsxldtrk */
  OPT_mtune_ctrl_ = 1896,                    /* -mtune-ctrl= */
  OPT_mtune_ = 1897,                         /* -mtune= */
  OPT_muintr = 1898,                         /* -muintr */
  OPT_mvaes = 1899,                          /* -mvaes */
  OPT_mveclibabi_ = 1900,                    /* -mveclibabi= */
  OPT_mvect8_ret_in_mem = 1901,              /* -mvect8-ret-in-mem */
  OPT_mvpclmulqdq = 1902,                    /* -mvpclmulqdq */
  OPT_mvzeroupper = 1903,                    /* -mvzeroupper */
  OPT_mwaitpkg = 1904,                       /* -mwaitpkg */
  OPT_mwbnoinvd = 1905,                      /* -mwbnoinvd */
  OPT_mwidekl = 1906,                        /* -mwidekl */
  OPT_mx32 = 1907,                           /* -mx32 */
  OPT_mxop = 1908,                           /* -mxop */
  OPT_mxsave = 1909,                         /* -mxsave */
  OPT_mxsavec = 1910,                        /* -mxsavec */
  OPT_mxsaveopt = 1911,                      /* -mxsaveopt */
  OPT_mxsaves = 1912,                        /* -mxsaves */
  OPT_n = 1913,                              /* -n */
  ...
  OPT_o = 1926,                              /* -o */
  OPT_objects = 1927,                        /* -objects */
  OPT_p = 1928,                              /* -p */
  OPT_pass_exit_codes = 1929,                /* -pass-exit-codes */
  /* OPT_pedantic = 1930, */                 /* -pedantic */
  OPT_pedantic_errors = 1931,                /* -pedantic-errors */
  OPT_pg = 1932,                             /* -pg */
  OPT_pie = 1933,                            /* -pie */
  OPT_pipe = 1934,                           /* -pipe */
  OPT_print_file_name_ = 1935,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1936,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1937,          /* -print-multi-directory */
  OPT_print_multi_lib = 1938,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1939,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1940,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 1941,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 1942,               /* -print-prog-name= */
  OPT_print_search_dirs = 1943,              /* -print-search-dirs */
  OPT_print_sysroot = 1944,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 1945,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 1946,                    /* -print-value */
  OPT_quiet = 1947,                          /* -quiet */
  OPT_r = 1948,                              /* -r */
  OPT_remap = 1949,                          /* -remap */
  OPT_reverse_sort = 1950,                   /* -reverse-sort */
  OPT_s = 1951,                              /* -s */
  OPT_save_temps = 1952,                     /* -save-temps */
  OPT_save_temps_ = 1953,                    /* -save-temps= */
  OPT_shared = 1954,                         /* -shared */
  OPT_shared_libgcc = 1955,                  /* -shared-libgcc */
  OPT_shared_libphobos = 1956,               /* -shared-libphobos */
  OPT_size_sort = 1957,                      /* -size-sort */
  /* OPT_specs = 1958, */                    /* -specs */
  OPT_specs_ = 1959,                         /* -specs= */
  OPT_static = 1960,                         /* -static */
  OPT_static_libasan = 1961,                 /* -static-libasan */
  OPT_static_libgcc = 1962,                  /* -static-libgcc */
  OPT_static_libgfortran = 1963,             /* -static-libgfortran */
  ...
  OPT_static_libstdc__ = 1970,               /* -static-libstdc++ */
  OPT_static_libtsan = 1971,                 /* -static-libtsan */
  OPT_static_libubsan = 1972,                /* -static-libubsan */
  OPT_static_pie = 1973,                     /* -static-pie */
  /* OPT_std_c__03 = 1974, */                /* -std=c++03 */
  /* OPT_std_c__0x = 1975, */                /* -std=c++0x */
  OPT_std_c__11 = 1976,                      /* -std=c++11 */
  OPT_std_c__14 = 1977,                      /* -std=c++14 */
  OPT_std_c__17 = 1978,                      /* -std=c++17 */
  /* OPT_std_c__1y = 1979, */                /* -std=c++1y */
  /* OPT_std_c__1z = 1980, */                /* -std=c++1z */
  OPT_std_c__20 = 1981,                      /* -std=c++20 */
  OPT_std_c__23 = 1982,                      /* -std=c++23 */
  /* OPT_std_c__2a = 1983, */                /* -std=c++2a */
  /* OPT_std_c__2b = 1984, */                /* -std=c++2b */
  OPT_std_c__98 = 1985,                      /* -std=c++98 */
  OPT_std_c11 = 1986,                        /* -std=c11 */
  OPT_std_c17 = 1987,                        /* -std=c17 */
  /* OPT_std_c18 = 1988, */                  /* -std=c18 */
  /* OPT_std_c1x = 1989, */                  /* -std=c1x */
  OPT_std_c2x = 1990,                        /* -std=c2x */
  /* OPT_std_c89 = 1991, */                  /* -std=c89 */
  OPT_std_c90 = 1992,                        /* -std=c90 */
  OPT_std_c99 = 1993,                        /* -std=c99 */
  /* OPT_std_c9x = 1994, */                  /* -std=c9x */
  OPT_std_f2003 = 1995,                      /* -std=f2003 */
  OPT_std_f2008 = 1996,                      /* -std=f2008 */
  OPT_std_f2008ts = 1997,                    /* -std=f2008ts */
  OPT_std_f2018 = 1998,                      /* -std=f2018 */
  OPT_std_f95 = 1999,                        /* -std=f95 */
  OPT_std_gnu = 2000,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2001, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2002, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2003,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2004,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2005,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2006, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2007, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2008,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2009,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2010, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2011, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2012,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2013,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2014,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2015, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2016, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2017,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2018, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2019,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2020,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2021, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2022, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2023,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2024, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2025, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2026, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2027, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2028, */         /* -std=iso9899:2018 */
  OPT_std_legacy = 2029,                     /* -std=legacy */
  OPT_stdlib_ = 2030,                        /* -stdlib= */
  OPT_symbol_ = 2031,                        /* -symbol= */
  OPT_symbolic = 2032,                       /* -symbolic */
  OPT_t = 2033,                              /* -t */
  OPT_time = 2034,                           /* -time */
  OPT_time_ = 2035,                          /* -time= */
  OPT_traditional = 2036,                    /* -traditional */
  OPT_traditional_cpp = 2037,                /* -traditional-cpp */
  OPT_tree_stats = 2038,                     /* -tree-stats */
  OPT_trigraphs = 2039,                      /* -trigraphs */
  OPT_type_stats = 2040,                     /* -type-stats */
  OPT_u = 2041,                              /* -u */
  OPT_undef = 2042,                          /* -undef */
  OPT_v = 2043,                              /* -v */
  OPT_version = 2044,                        /* -version */
  OPT_w = 2045,                              /* -w */
  OPT_wrapper = 2046,                        /* -wrapper */
  OPT_x = 2047,                              /* -x */
  OPT_z = 2048,                              /* -z */
  N_OPTS,
  OPT_SPECIAL_unknown,
